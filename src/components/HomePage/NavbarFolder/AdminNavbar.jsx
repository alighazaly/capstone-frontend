...
import { Avatar ,Dialog,Button,Stack,Rating,DialogTitle,TextareaAutosize} from '@mui/material';
...
const AdminNavbar = () => {
  ...
  const [profileBase, setProfileBase] = useState(userData?.data?.imageSrc || null);
  ...
  return (
    <div className='flex justify-between items-center border-b'>
        ...
        <div className='hidden lg:flex relative justify-center items-center mt-5 shadow-sm rounded-full shadow-gray-400 bg-[#003740]'>
            <input type='search' placeholder='' className='py-2.5 w-[70rem] rounded-full outline-0 bg-[#003740]'></input>
            <div className='flex justify-between absolute text-[#fff] w-full pr-2 pl-2'>
                ...
                <button className='flex-grow flex items-center justify-center font-semibold border-r border-white' onClick={() => navigate('/upload')}><FiUpload /><span className="ml-1.5">Add</span></button>
                <button className='flex-grow flex items-center justify-center font-semibold' onClick={() => navigate('/dashboard')}><TbChartDots /><span className="ml-1.5">Dashboard</span></button>
            </div>
        </div>
...
>
  <List>
    ...
    <ListItem button style={{ borderBottom: '1px solid #003740' }} onClick={() => navigate('/dashboard')}>
      <ListItemIcon style={{ color: '#003740' }}><TbChartDots /></ListItemIcon>
      <ListItemText primary="Dashboard" style={{ color: '#003740' }} />
    </ListItem>
